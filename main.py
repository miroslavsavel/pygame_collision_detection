...
def bouncing_rect():
    ...
    # collision between rect, it doesnt tell me where exactly
    ...
    if moving_rect.colliderect(other_rect):
        ...
        if abs(other_rect.top - moving_rect.bottom) < collision_tolerance and y_speed > 0:    # if this is True we know the collision happened on the top
            y_speed *= -1
